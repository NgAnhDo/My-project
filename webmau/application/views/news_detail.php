			...
			<div class="row">
				<div class="col-sm-9">
					<div class="mottinchuan mb-3  wow  fadeInUp fontroboto">
						...
						<?php foreach ($mangtinchitiet as $value): ?>

						<img src="<?= $value['anhtin'] ?>" alt="">
						<a href="" class="tieudetin1 fontoswarld"><?= $value['tieude'] ?></a>
						<div class=""><?= date('d/m/Y - G:i - A',$value['ngaytao']) ?> In <span class="vang"> <?= $value['tendanhmuc'] ?></span></div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="card-deck-wrapper">
							<div class="card-deck">
								<div class="card">
									<a href="<?= base_url(); ?>news/chiTietTin/<?= $value['id'] ?>"><img class="card-img-top img-fluid" src="<?= $value['anhtin'] ?>" alt="Card image cap"></a>
									<div class="card-block">
										<a class="tieudetin1 fontoswarld " href="<?= base_url(); ?>news/chiTietTin/<?= $value['id'] ?>"><h4 class="card-title "><?= $value['tieude'] ?></h4></a>
